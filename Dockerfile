...
Center for Biosustainability, Technical University of Denmark" \
    ...
    dk.dtu.biosustain.warehouse.alpine.build.base-tag="${BASE_TAG}" \
    dk.dtu.biosustain.warehouse.alpine.build.commit="${BUILD_COMMIT}" \
    dk.dtu.biosustain.warehouse.alpine.build.timestamp="${BUILD_TIMESTAMP}"
